...
export const sessionAPI = {
  ...
  adminLogin: async (clienteId) =>
    (await api.post('/session-manager/admin/login', { cliente_id: clienteId })).data,

  adminLogout: async (clienteId) =>
    (await api.post('/session-manager/admin/logout', { cliente_id: clienteId })).data
};
